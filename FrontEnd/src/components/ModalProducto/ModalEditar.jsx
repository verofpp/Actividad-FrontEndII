...
import { editarProducto } from "../../services/ProductosService.js";
    ...
    if (productoId && productos.length > 0) {
      ...
      if (productoSeleccionado) {
        setProductoData({
          ...
          tipo_cafe_id: productoSeleccionado.tipo_cafe_id || "",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      try {
        ...
        setFormError(errorData.message || "Error al actualizar el producto");
      } catch {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-orange-300 rounded-2xl p-6 w-full max-w-2xl mx-auto transform transition-all duration-300 scale-95 opacity-0 shadow-2xl shadow-orange-950"
        ...
        <h2 className="text-3xl font-bold text-orange-800 mb-6">Editar Producto #{productoId}</h2>
